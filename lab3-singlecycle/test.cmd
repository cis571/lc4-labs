...
iverilog.exe -g2012 -W all -I include -D GENERATE_VCD=1 -DINPUT_FILE=\"test_data/%1.ctrace\" -DOUTPUT_FILE=\"test_data/%1.output\" -DMEMORY_IMAGE_FILE=\"test_data/%1.hex\" -DVCD_FILE=\"%1.vcd\" -o %1.out lc4_alu.v lc4_cla.v lc4_decoder.v lc4_divider.v lc4_regfile.v lc4_single.v include/register.v include/lc4_memory.v include/clock_util.v include/delay_eight_cycles.v include/bram.v
vvp.exe %1.out
